        ...
        <div class="hidden md:block md:w-1/2 bg-gradient-to-br from-[#051a9a] via-[#0b3be9] to-[#0079f4] relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center h-full text-white p-8">
                ...
                <div class="max-w-md">
                    ...
                    <!-- Tarjetas de beneficios -->
                    <div class="space-y-4">
                        <div class="glass-effect rounded-lg p-4 backdrop-blur-md bg-white">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 bg-[#f2f2f2] rounded-full p-2 mr-4">
                                    <!-- icono -->
                                </div>
                                <div>
                                    <h3 class="font-semibold text-gray-800 mb-1">Tests profesionales</h3>
                                    <p class="text-sm text-gray-600">Basados en metodologías reconocidas y estudios psicométricos avanzados</p>
                                </div>
                            </div>
                        </div>
                        <div class="glass-effect rounded-lg p-4 backdrop-blur-md bg-white">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-800 mb-1">+300 carreras analizadas</h3>
                                    <p class="text-sm text-gray-600">Información detallada sobre programas académicos, universidades y oportunidades laborales</p>
                                </div>
                            </div>
                        </div>
                    </div>
