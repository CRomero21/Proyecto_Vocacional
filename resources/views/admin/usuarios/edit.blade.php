...
<div class="max-w-7xl mx-auto py-10 px-4 sm:px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Panel lateral de información - AHORA PRIMERO EN MÓVIL PARA MEJOR UX -->
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="flex items-center mb-3">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ 
                                    ...
                                    ($usuario->role == 'coordinador' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800') 
                                }}">
                                    {{ 
                                        $usuario->role == 'superadmin' ? 'Superadministrador' : 
                                        ($usuario->role == 'coordinador' ? 'Coordinador' : 'Estudiante') 
                                    }}
                                </span>
                            </div>
                            <p class="text-xs text-gray-500">
                                {{ 
                                    ...
                                    ($usuario->role == 'coordinador' ? 'Puede gestionar informes y ver estadísticas, pero no tiene acceso a la configuración del sistema.' : 'Solo puede realizar tests y ver sus propios resultados.') 
                                }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.usuarios.update', $usuario) }}">
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="relative flex items-start">
                                                <div class="flex items-center h-5">
                                                    <input id="role-coordinador" name="role" value="coordinador" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" {{ old('role', $usuario->role) == 'coordinador' ? 'checked' : '' }}>
                                                </div>
                                                <div class="ml-3 text-sm">
                                                    <label for="role-coordinador" class="font-medium text-gray-700">Coordinador</label>
                            ...
                            <!-- Cambio de contraseña (opcional) - CORREGIDO -->
                            <div x-data="{ showPasswordFields: false }">
                                ...
                                <div x-show="showPasswordFields" style="display: none;">
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <div class="mt-1 relative rounded-md shadow-sm">
                                                ...
                                                <input type="password" name="password" id="password" autocomplete="new-password" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="Nueva contraseña">
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1 relative rounded-md shadow-sm">
                                                ...
                                                <input type="password" name="password_confirmation" id="password_confirmation" autocomplete="new-password" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="Repetir contraseña">
                                            </div>
                                        </div>
